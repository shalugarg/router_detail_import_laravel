...
function getduplicates() {
  ...
  var sapid_array = [];
  var $tableID = $('#table');
  var $rows = $tableID.find('tr:not([id])');
  var rows_without_header = $tableID.find('tr').not(':first');
  ...
  for (var i = 0; i < data_row_count; i++) {
    sapid_array.push($('#sapid' + i).val());
  }

  var hostname_array = [];

  for (var _i = 0; _i < data_row_count; _i++) {
    hostname_array.push($('#hostname' + _i).val());
  }
...
$(document).ready(function () {
  ...
  var $tableID = $('#table'); // var data_error=0;
...
__webpack_require__(/*! C:\xampp8\htdocs\laravel-test\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp8\htdocs\laravel-test\resources\sass\app.scss */"./resources/sass/app.scss");
